...
from .benchmark import ANNSet1_fMRI_benchmarkLinear
...
benchmark_registry['ANNSet1_fMRI.train.language_top_90-linear'] = lambda: ANNSet1_fMRI_benchmarkLinear(atlas='train.language_top_90')
