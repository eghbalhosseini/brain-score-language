...
if __name__ == '__main__':
    ...
    roberta_score_p234 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/roberta_score_p234.pkl')
    roberta_score_p384 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/roberta_score_p384.pkl')
    ...
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/roberta_score_p234_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(roberta_score_p234_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/roberta_score_p384_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(roberta_score_p384_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/roberta_score_p234_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(roberta_score_p234_ds_min, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/roberta_score_p384_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(roberta_score_p384_ds_min, f)
    print('xlm-mlm-en-2048')
    candidate = load_model('xlm-mlm-en-2048')
    xlm_score_p234 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlm_score_p234.pkl')
    xlm_score_p384 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlm_score_p384.pkl')
    ...
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlm_score_p234_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(xlm_score_p234_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlm_score_p384_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(xlm_score_p384_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlm_score_p234_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(xlm_score_p234_ds_min, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlm_score_p384_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(xlm_score_p384_ds_min, f)

    print('xlnet-large-cased')
    candidate = load_model('xlnet-large-cased')
    xlnet_score_p234 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlnet_score_p234.pkl')
    xlnet_score_p384 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlnet_score_p384.pkl')
    ...
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlnet_score_p234_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(xlnet_score_p234_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlnet_score_p384_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(xlnet_score_p384_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlnet_score_p234_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(xlnet_score_p234_ds_min, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/xlnet_score_p384_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(xlnet_score_p384_ds_min, f)

    print('albert-xxlarge-v2')
    candidate = load_model('albert-xxlarge-v2')
    albert_score_p234 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/albert_score_p234.pkl')
    albert_score_p384 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/albert_score_p384.pkl')
    ...
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/albert_score_p234_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(albert_score_p234_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/albert_score_p384_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(albert_score_p384_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/albert_score_p234_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(albert_score_p234_ds_min, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/albert_score_p384_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(albert_score_p384_ds_min, f)

    print('bert-base-uncased')
    candidate = load_model('bert-base-uncased')
    bert_score_p234 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/bert_score_p234.pkl')
    bert_score_p384 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/bert_score_p384.pkl')
    ...
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/bert_score_p234_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(bert_score_p234_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/bert_score_p384_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(bert_score_p384_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/bert_score_p234_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(bert_score_p234_ds_min, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/bert_score_p384_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(bert_score_p384_ds_min, f)

    print('gpt2-xl')
    candidate = load_model('gpt2-xl')
    gpt2_score_p234 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/gpt2_score_p234.pkl')
    gpt2_score_p384 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/gpt2_score_p384.pkl')
    ...
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/gpt2_score_p234_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(gpt2_score_p234_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/gpt2_score_p384_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(gpt2_score_p384_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/gpt2_score_p234_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(gpt2_score_p234_ds_min, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/gpt2_score_p384_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(gpt2_score_p384_ds_min, f)

    print('ctrl')
    candidate = load_model('ctrl')
    ctrl_score_p234 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/ctrl_score_p234.pkl')
    ctrl_score_p384 = pd.read_pickle(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/ctrl_score_p384.pkl')
    ...
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/ctrl_score_p234_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(ctrl_score_p234_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/ctrl_score_p384_ds_max.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(ctrl_score_p384_ds_max, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/ctrl_score_p234_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
        pickle.dump(ctrl_score_p234_ds_min, f)
    save_dir = Path(f'/om/user/ehoseini/MyData/fmri_DNN/outputs/ctrl_score_p384_ds_min.pkl')
    with open(save_dir.__str__(), 'wb') as f:
